...
## Context
- My company (Appian) provides a generous offering of ~$7,000 per year for self-study. The catch is you have to either pass in order to receive the subsidy.
- I was eyeing for this certification for a while (6 months) and bit the bullet and booked the exam 2 months in advanced 
...
- For the first few weeks, I watched the lectures and did follow along. The pace though was a bit slow so by with 4 weeks down (so half way) I was able to finish around 30% of the course content.
- Started to not do the follow along and watch the videos on 2x speed (sometimes 3x with the javascript)
```javascript
document.querySelector('video).playbackRate = 3.0
```
-  1 week left, and was around 80% done, took 3 days of work and watched the rest of it with 2 days to spare.
### Practice Papers
...
- Score on each practice exam (I didn't do it in this order, rather a mix of both courses but generally starting from Test 1 to 5)
